...
const char* SSID = "Oi_Velox_WiFi_713F"; // SSID / nome da rede WI-FI que deseja se conectar
const char* PASSWORD = "thassyaa"; // Senha da rede WI-FI que deseja se conectar
